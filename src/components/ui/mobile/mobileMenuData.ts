...
export type MenuDiscountType = "percentage" | "manual";
...
export interface MenuItem {
  ...
  /** Pricing / promo — optional; omit or set show_discount false to hide chip & strikethrough. */
  discount_type?: MenuDiscountType | null;
  discount_value?: number | null;
  seasonal_active?: boolean;
  show_discount?: boolean;
  /** Inclusive YYYY-MM-DD when seasonal_active */
  seasonal_from?: string | null;
  seasonal_until?: string | null;
  /** For discount_type manual: variant id → list (strikethrough) price */
...
export const MENU_BY_CATEGORY: Record<MenuCategoryId, MenuItem[]> = {
  chicken: [
    ...
    },
    {
      ...
      image: "/menu-images/chk-sis-gravy.jpg",
      category: "chicken",
      variants: [
    ...
    },
    {
      ...
      image: "/menu-images/chk-idli-gravy.jpg",
      category: "chicken",
      variants: [
